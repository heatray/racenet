...
function showNext() {
    ...
    _gaq.push(['_trackEvent', 'Vehicles', 'ViewHoonigan']);
}
...
function showPrevious() {
    ...
    _gaq.push(['_trackEvent', 'Vehicles', 'ViewDemolition']);
}
...
function showFeature() {
    ...
    _gaq.push(['_trackEvent', 'Vehicles', 'ViewRace']);
}
...
$(document).ready(function () {
    ...
    $('.navigation ul li').click(function () {
        ...
        _gaq.push(['_trackEvent', 'Vehicles', 'FriendOptionClick']);
    });
});
